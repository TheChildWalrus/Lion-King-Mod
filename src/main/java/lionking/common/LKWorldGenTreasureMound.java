...
public class LKWorldGenTreasureMound extends WorldGenerator {
	...
	private ItemStack pickLoot(Random random) {
		...
		if (i == 5) {
			...
			switch (j) {
				case 0:
					return new ItemStack(mod_LionKing.swordCorrupt);
				case 1:
					return new ItemStack(mod_LionKing.pickaxeCorrupt);
				case 2:
					return new ItemStack(mod_LionKing.swordKivulite);
				case 3:
					return new ItemStack(mod_LionKing.pickaxeKivulite);
				case 4:
